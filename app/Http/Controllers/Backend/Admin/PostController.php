...
class PostController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->number('administrator_id', __('fields.Administrator id'));
        $form->text('title', __('fields.Title'));
        $form->text('contents', __('fields.Contents'));
        $form->text('status', __('fields.Status'));
        $form->datetime('published_at', __('fields.Published at'))->default(date('Y-m-d H:i:s'));
